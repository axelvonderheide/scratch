...
from enthought.traits.api import \
    ...
    Any, Enum, Instance, on_trait_change, Dict, false, Button, Event, Bool
...
from numpy import frompyfunc, arange, sqrt, exp, log, abs
import time
...
class DanielsSmithDistrib( HasTraits ):
    ...
    def get_mean_std( self, nf ):
        ...
        b = scale * pow( shape, -( 1.0 / shape + 1.0 / 3.0 ) ) * exp( -1.0 / ( 3.0 * shape ) )
...
class ChainOfBundlesAnalysis( HasTraits ):
    '''
    Manage the distributions representing the changed bundle.
    '''
