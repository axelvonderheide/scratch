...
#                        nu = 0.2 ) 
    ...
    fe_domain1 = FEGridDomain( coord_min = (0,0,0),
                               coord_max = (0.0375,0.075,0.), 
                               shape   = discr,
                               fets_eval = fets_eval )

    fe_domain2 = FEGridDomain( coord_min = (0.,0.075,0),
                               coord_max = (0.0375,0.15,0.), 
                               shape   = discr,
                               fets_eval = fets_eval )
    
    fe_domain3 = FEGridDomain( coord_min = (0.0375,0.,0),
                               coord_max = (0.2625,0.075,0.), 
                               shape   = (20,2),
                               fets_eval = fets_eval )
    
    fe_domain4 = FEGridDomain( coord_min = (0.0375,0.075,0),
                               coord_max = (0.2625,0.15,0.), 
                               shape   = (20,2),
                               fets_eval = fets_eval )
    
    fe_domain5 = FEGridDomain( coord_min = (0.2625,0.,0),
                               coord_max = (0.3375,0.075,0.), 
                               shape   = (20,2),
                               fets_eval = fets_eval )
    
    fe_domain6 = FEGridDomain( coord_min = (0.2625,0.075,0),
                               coord_max = (0.3375,0.15,0.), 
                               shape   = (20,2),
                               fets_eval = fets_eval )
    
    fe_domain7 = FEGridDomain( coord_min = (0.3375,0.,0),
                               coord_max = (0.4875,0.075,0.), 
                               shape   = (20,2),
                               fets_eval = fets_eval )
    
    fe_domain8 = FEGridDomain( coord_min = (0.3375,0.075,0),
                               coord_max = (0.4875,0.15,0.), 
                               shape   = (20,2),
                               fets_eval = fets_eval )
    
    fe_domain9 = FEGridDomain( coord_min = (0.4875,0.,0),
                               coord_max = (0.6375,0.075,0.), 
                               shape   = (20,2),
                               fets_eval = fets_eval )
    
    fe_domain10 = FEGridDomain( coord_min = (0.4875,0.075,0),
                               coord_max = (0.6375,0.15,0.), 
                               shape   = (20,2),
                               fets_eval = fets_eval )
    
    fe_domain11 = FEGridDomain( coord_min = (0.6375,0.,0),
                               coord_max = (0.675,0.075,0.), 
                               shape   = (20,2),
                               fets_eval = fets_eval )
    
    fe_domain12 = FEGridDomain( coord_min = (0.6375,0.075,0),
                               coord_max = (0.675,0.15,0.), 
                               shape   = (20,2),
                               fets_eval = fets_eval )
    ...
    ts = TS( sdomain = fe_domain,
             ...
             bcond_list =  [ BCDofGroup( var='u', value = 0., dims = [0,1],
                                         get_dof_method = fe_domain3.get_bottom_left_dofs ),
                             BCDofGroup( var='u', value = 0., dims = [0,1],
                                         get_dof_method = fe_domain4.get_bottom_right_dofs ),
                            BCDofGroup( var='u', value = -0.0004, dims = [1],
                                         get_dof_method = fe_domain1.get_top_right_dofs ),
                             BCDofGroup( var='u', value = 0., dims = [0,1],
                             ...
                             BCDofGroup( var='u', value = 0., dims = [0,1],
                                         ...
                                         get_link_dof_method = fe_domain2.get_bottom_dofs,
                                         link_coeffs = [1.] ),
                            BCDofGroup( var='u', value = 0., dims = [0,1],
                                         get_dof_method = fe_domain3.get_top_dofs,
                                         get_link_dof_method = fe_domain1.get_bottom_dofs,
                                         link_coeffs = [1.] )
