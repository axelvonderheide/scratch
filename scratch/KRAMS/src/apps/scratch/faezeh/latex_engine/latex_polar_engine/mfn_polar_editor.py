...
def coord_trans_plt(r_value, frac_noplot, plotrange_min, plotrange_max):
    r_a = frac_noplot   
    if (plotrange_max == plotrange_min):
        print "Error: Empty plot because plotrange_min and plotrange_max are identical" 
    elif r_value < plotrange_min :
        r_value_plt = r_a
...
#        plot_unitcircle_flag = True
    ...
    def update_editor(self):
        ...
        print 'unitcircle_arr.all()',unitcircle_arr.all()
        print 'frac_noplot',frac_noplot
