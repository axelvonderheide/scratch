#!/usr/bin/env python
"""
Draws a line plot with several points labeled.  Demonstrates how to annotate
plots.
...
from enthought.chaco.api import create_line_plot, add_default_axes, add_default_grids, \
                                 OverlayPlotContainer, DataLabel, TextBoxOverlay
...
class PlotFrame(DemoFrame):
    def _create_window(self):
        ...
        # from its data point.
        label = DataLabel(component=plot, data_point=(5,0.5), # data_point=(x[40], y[40]),
                          label_position=(100,100), padding=40,
        ...
        text = TextBoxOverlay(text = 'Another text', alternate_position = (400,0.8) )
