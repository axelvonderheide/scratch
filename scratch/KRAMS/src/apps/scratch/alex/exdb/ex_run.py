...
from traits.editors.mpl_figure_editor import \
    MPLFigureEditor
...
import os
import csv
from ibvpy.util.find_class import _find_class
...
class ExRun( HasTraits ):
    ...
    process_source_data = DelegatesTo( 'ex_type' )
...
if __name__ == '__main__':
    ...
    print 'processed data', exrun.processed_data_array.shape
