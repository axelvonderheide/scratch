...
class FETSEvalXFEM( FETSEval ):
    
    
    base_elem = Instance(FETSEval)
    
    dof_r = List
    
    def _dof_r_default(self):
        return self.base_elem.dof_r
    
    geo_r = List
    
    def _geo_r_default(self):
        return self.base_elem.geo_r
    ...
    def get_dNr_geo_mtx(self, r_pnt):
        return self.base_elem.get_dNr_geo_mtx(r_pnt)
    
    def get_dNr_mtx(self,r_pnt):
        return self.base_elem.get_dNr_mtx(r_pnt)
    
    def get_N_geo_mtx(self, r_pnt):
        return self.base_elem.get_N_geo_mtx(r_pnt)
