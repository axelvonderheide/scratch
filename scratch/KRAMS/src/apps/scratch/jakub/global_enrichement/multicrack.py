...
@author: jakub
'''
#TODO: adapt to new ls structure
...
#        from fets2D4q9utf import FETS2D4Q9UTF
        ...
        fets_eval = FETS2DTF( parent_fets = FETS2D4Q(),
                              mats_eval = MATS2D5Bond( E_m = 30, nu_m = 0.,
                                                       E_f = 3, nu_f = 0.,
                                                       G = 30.,
        ...
        if enr:
            fe_xdomain = XFESubDomain( domain = fe_domain,
                                       ...
                                       fe_grid_slice = fe_grid1['(X+0.5)**2 + (Y-2.)**2 - 5.01'] )
            fe_xdomain2 = XFESubDomain( domain = fe_domain,
                                       fets_eval = xfets_eval,
                                       #fe_grid_idx_slice = fe_grid1[1,0],
                                       fe_grid_slice = fe_grid1['5*(X-0.2)**2 + 2.* (Y-2.)**2 - 20.065'] )
            fe_xdomain3 = XFESubDomain( domain = fe_domain,
                                       fets_eval = xfets_eval,
                                       #fe_grid_idx_slice = fe_grid1[1,0],
                                       fe_grid_slice = fe_grid1['3*(X+0.5)**2 + (Y-2.)**2 - 30.02'] )
...
#                                 var = 'sig_app', idx = 0, warp = True ),
                            ...
                            RTraceDomainListField( name = 'Strain reinf' ,
                                            ...
                                            warp = True,
                                            warp_var = 'u_f' ),
                            RTraceDomainListField( name = 'Strain bond' ,
                                            var = 'eps_b',
                                            warp = True,
                                            warp_var = 'u_f' ),
