...
if __name__ == '__main__':        
    def example_2d():
        ...
        from strong_weak.fets_strong_weak_tf import FETSStrongWeakTF
...
#        from fets2D4q9utf import FETS2D4Q9UTF
        ...
        xfets_eval = FETSStrongWeakTF( parent_fets = fets_eval, int_order = 5 )
...
#                                          slice =  fe_grid1[-1,:,-1,:]),
#                                BCSlice(var='u', value = 0., dims = [1,3],
#                                          slice =  fe_grid1[:,:,:,:]),
