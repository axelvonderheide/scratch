# three domains two of them the matrix, the another one is the filament
# the stiffness of the bond are.varied, in order to find the maximum and the minimum of the bond stiffness.   
#
...
fe_domain2 = FEGrid( coord_min = (0.,0.,0.),  
                     coord_max = ( 0.002,0.004,0.004), 
                     shape   = ( fineness_x_adhesive, fineness, fineness ),
                     fets_eval = fets_eval2 )

fe_domain3 = FEGrid( coord_min = (0.002,0.,0.),  
...
ts = TS( sdomain = [ fe_domain1, fe_domain2, fe_domain3 ], 
         ...
         bcond_list =  [    
                        BCDofGroup( var='u', value = 0., dims = [0],
                                    ...
                                    link_coeffs = [1.] ), # combine the two domain
                        BCDofGroup( var='u', value = 0., dims = [0],
