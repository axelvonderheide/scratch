...
def cov_tau_r(E_f, V_f, tau, m, sV0):
    #loop with fix tau and array r
...
#3D Plots
cov_tau_r(E_f, V_f, tau, m, sV0)
#det_tau_r(E_f, V_f, tau, m, sV0)
#cov_tau_det_r(E_f, V_f, tau, m, sV0)
#cov_r_det_tau(E_f, V_f, tau, m, sV0)
