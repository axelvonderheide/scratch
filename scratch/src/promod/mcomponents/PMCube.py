...
from enthought.traits.api import \
    Button, on_trait_change, Trait, Instance, Property, cached_property, Array, Float, Int
...
from ibvpy.mesh.cell_grid.cell_grid_examples.mcell import MGridCellSpec, MGridCell


class PMCube( SDomain ):
    '''Here is the product model cube.
    '''
    ...
    def redraw(self):
        ...
        self.mvp_mgrid_ngeo_labels.redraw()
    ...
    # UI - related methods
    #------------------------------------------------------------------
    traits_view = View(Item('refresh_button', show_label = False ),
                       resizable = True,
                       scrollable = True,
                       height = 0.5,
                       width = 0.5)        
...
if __name__ == '__main__':
    ...
    pmc = PMCube()
    ibvpy_app = IBVPyApp( ibv_resource = pmc )
    ibvpy_app.main()
