...
class CodeGenCompiled(CodeGen):
    ...
    # get the randomization arrays
    dG_arrs = Property(List, depends_on = 'tvars')
    @cached_property
    ...
    arg_names = Property(depends_on = 'rf_change, rand_change, +codegen_option')
    @cached_property
    ...
    compiled_eps_loop_feature = Property(depends_on = 'compiled_eps_loop')
    @cached_property
    ...
    #===========================================================================
    cached_dG_feature = Property(depends_on = 'cached_dG')
    @cached_property
    ...
    #------------------------------------------------------------------------------------
    code = Property(depends_on = 'rf_change, rand_change, +codegen_option, eps_change')
    @cached_property
    def _get_code(self):
        ...
        if self.compiled_eps_loop:
            ...
            #
            n_eps = len(self.spirrid.evar_list[0])
        ...
        for name, distr in zip(self.var_names, self.spirrid.tvar_list):
    ...
    extra_args = Property(depends_on = 'use_extra, +codegen_option')
    @cached_property
