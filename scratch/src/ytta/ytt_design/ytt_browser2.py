...
class ExRun( HasTraits ):
    ...
    def get_linear_data(self):
        ...
        strain_0 = self.strain_at_max_stiffness - stress_at_max_stiffness / self.max_stiffness
        ...
        ydata = array([ 0.,
                        ...
                        (self.strain_at_max_stress - strain_0) * self.max_stiffness,
                        0. ], dtype = 'float_' )
        return xdata, ydata
...
path = os.path.join( get_home_directory(), 'simviz_data/rubber_pullout/rubber_pullout.eds' )
