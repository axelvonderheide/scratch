...
from enthought.traits.api import Array, Enum, Float, HasTraits, Int, Property, cached_property, Range, Str
from enthought.traits.ui.api import Item, View, Handler
from enthought.traits.ui.menu import OKButton, CancelButton, Action, Menu, MenuBar
...
class MFnPolar(HasTraits):
    ...
    frac_noplot          = Range( 0., 1 , 0.3, desc = 'fraction of the plot-circle that is not used for display of plot values ', auto_set = False)
...
#                                  orientation="h",
    ...
    info = Property( Float, depends_on = 'current_theta,alpha,delta_alpha,delta_trans,strech_residual,strech_quasibrittle, plotrange_min, plotrange_max' )
    @cached_property
