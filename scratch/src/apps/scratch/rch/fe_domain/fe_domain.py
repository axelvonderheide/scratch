...
if __name__ == '__main__':
    ...
    d1 = FESubDomain( name = 'd1', domain = domain1 )
    d2 = FESubDomain( name = 'd2', parent = d1 )
    d3 = FESubDomain( name = 'd3', parent = d2 )
    d4 = FESubDomain( name = 'd4', parent = d3 ) 
    d5 = FESubDomain( name = 'd5', domain = domain1 ) 
    ...
    print d4, d4.get_dof_map()
    # add new subdomain
    c1 = FESubDomain( name = 'c1', parent = d1 )
