...
from scontext import ISDomain, SDomain, SContext
from bc import BCondMngr
from rtrace import RTraceMngr
...
class TStepper(HasStrictTraits):
    ...
    def eval( self, step_flag, U_k, t_n, t_n1 ):
        ...
        #
        F_int, K = self.tse.get_corr_pred( sctx, U_k, t_n, t_n1 )
