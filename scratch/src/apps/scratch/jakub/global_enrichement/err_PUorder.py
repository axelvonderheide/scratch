...
y1 = 1.-np.array([0.978135883808,0.968210220337,0.955681741238,0.927601695061,0.900899589062,0.81528031826,0.621305942535], dtype = float)
...
plt.xlim(7,150)
#plt.ylim(0.60,1.1)
plt.legend( (p1[0], p2[0],p3[0]), (r'Q16 1.PU', r'Q12 3.PU', r'Q16 3.PU'), loc='upper right', prop = {'size':20})#,
                                                                                  #'family':'serif'})
