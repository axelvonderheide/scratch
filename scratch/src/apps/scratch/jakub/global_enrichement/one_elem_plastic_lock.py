...
#        from fets2D4q9utf import FETS2D4Q9UTF
        ...
        ts = TS( dof_resultants = True,
                 ...
                 bcond_list = [
                                ...
                                BCDof( var = 'u', dof = 32, value = 0. ),
                                BCDof( var = 'u', dof = 33, value = 0. ),
                                BCDof( var = 'u', dof = 34, value = 0. ),
                                BCDof( var = 'u', dof = 35, value = 0. ),

                                BCDof( var = 'u', dof = 36, value = 0. ),
                                BCDof( var = 'u', dof = 37, value = 0. ),
                                BCDof( var = 'u', dof = 38, value = 0. ),
                                BCDof( var = 'u', dof = 39, value = 0. ),
                                           ],
                 rtrace_list = [
