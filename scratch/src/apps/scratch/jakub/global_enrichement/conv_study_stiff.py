...
if __name__ == '__main__':        
    def example_2d():
        ...
        from numpy import dot, array, linalg, sum, deg2rad, sinh, cosh,\
         zeros_like, vstack
...
#        from fets2D4q9utf import FETS2D4Q9UTF
        ...
        fets_eval = FETS2DTF(parent_fets = FETS2D4Q16U(),
                              mats_eval = MATS2D5Bond(E_m = 1000000., nu_m = 0.,
                                                       E_f = 1., nu_f = 0.,
                                                       G = 1., 
        ...
        fets_eval.rte_dict.update( {'eps_mn' : RTraceEvalElemFieldVar( eval = get_eps_mn ), 
                                    ...
                                    'err_u' : RTraceEvalElemFieldVar( eval = get_err_u ),
        ...
        fe_grid1 = FEGrid( 
#                          coord_min = (-1,55,-1.05,0.),
#                          coord_max = (1.55,1.05,0.), 
                          coord_max = (3.1,2.1,0.), 
