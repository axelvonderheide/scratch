...
from ibvpy.mesh.rt_domain_list import \
...
from ibvpy.mats.mats2D.mats2D_plastic.yield_face2D import J2
from ibvpy.fets.fets2D.fets2D4q import FETS2D4Q
from ibvpy.mesh.fe_domain_list import FEDomainList
from ibvpy.dots.dots_eval import UniformDomainTSE
...
#                              record_on = 'update',
#                              warp = True),
                              RTraceDomainListField(name = 'Plastic Strain' ,
                              var = 'eps_p', idx = 1,
                              record_on = 'update',
                              warp = True),
