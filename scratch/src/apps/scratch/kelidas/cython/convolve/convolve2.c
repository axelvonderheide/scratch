/* Generated by Cython 0.13 on Fri Aug 26 09:41:39 2011 */
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_9convolve2_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_9convolve2_DTYPE_t), 'I' };
...
/* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":23
...
static PyObject *__pyx_pf_9convolve2_naive_convolve(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_9convolve2_naive_convolve(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("convolve2.naive_convolve");
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_g), __pyx_ptype_5numpy_ndarray, 1, "g", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_f, (PyObject*)__pyx_v_f, &__Pyx_TypeInfo_nn___pyx_t_9convolve2_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_g, (PyObject*)__pyx_v_g, &__Pyx_TypeInfo_nn___pyx_t_9convolve2_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":24
 * # more efficient. (In this example this doesn't matter though.)
 * def naive_convolve(np.ndarray[DTYPE_t, ndim=2] f, np.ndarray[DTYPE_t, ndim=2] g):
 *     if g.shape[0] % 2 != 1 or g.shape[1] % 2 != 1:             # <<<<<<<<<<<<<<
 *         raise ValueError("Only odd dimensions on filter supported")
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":25
 * def naive_convolve(np.ndarray[DTYPE_t, ndim=2] f, np.ndarray[DTYPE_t, ndim=2] g):
 *     if g.shape[0] % 2 != 1 or g.shape[1] % 2 != 1:
 *         raise ValueError("Only odd dimensions on filter supported")             # <<<<<<<<<<<<<<
 *     assert f.dtype == DTYPE and g.dtype == DTYPE
 ...
 */
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":26
 *     if g.shape[0] % 2 != 1 or g.shape[1] % 2 != 1:
 *         raise ValueError("Only odd dimensions on filter supported")
 *     assert f.dtype == DTYPE and g.dtype == DTYPE             # <<<<<<<<<<<<<<
 *     # The "cdef" keyword is also used within functions to type variables. It
 ...
 */
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":36
 ...
 */
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":37
 *     # array indices.
 *     cdef int vmax = f.shape[0]
 *     cdef int wmax = f.shape[1]             # <<<<<<<<<<<<<<
 *     cdef int smax = g.shape[0]
 ...
 */
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":38
 *     cdef int vmax = f.shape[0]
 *     cdef int wmax = f.shape[1]
 *     cdef int smax = g.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int tmax = g.shape[1]
 ...
 */
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":39
 *     cdef int wmax = f.shape[1]
 *     cdef int smax = g.shape[0]
 *     cdef int tmax = g.shape[1]             # <<<<<<<<<<<<<<
 *     cdef int smid = smax // 2
 ...
 */
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":40
 *     cdef int smax = g.shape[0]
 *     cdef int tmax = g.shape[1]
 *     cdef int smid = smax // 2             # <<<<<<<<<<<<<<
 *     cdef int tmid = tmax // 2
 ...
 */
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":41
 *     cdef int tmax = g.shape[1]
 *     cdef int smid = smax // 2
 *     cdef int tmid = tmax // 2             # <<<<<<<<<<<<<<
 *     cdef int xmax = vmax + 2*smid
 ...
 */
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":42
 *     cdef int smid = smax // 2
 *     cdef int tmid = tmax // 2
 *     cdef int xmax = vmax + 2*smid             # <<<<<<<<<<<<<<
 *     cdef int ymax = wmax + 2*tmid
 ...
 */
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":43
 *     cdef int tmid = tmax // 2
 *     cdef int xmax = vmax + 2*smid
 *     cdef int ymax = wmax + 2*tmid             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[DTYPE_t, ndim=2] h = np.zeros([xmax, ymax], dtype=DTYPE)
 ...
 */
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":44
 *     cdef int xmax = vmax + 2*smid
 *     cdef int ymax = wmax + 2*tmid
 *     cdef np.ndarray[DTYPE_t, ndim=2] h = np.zeros([xmax, ymax], dtype=DTYPE)             # <<<<<<<<<<<<<<
 *     cdef int x, y, s, t, v, w
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_h, (PyObject*)__pyx_t_8, &__Pyx_TypeInfo_nn___pyx_t_9convolve2_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":56
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":57
 *     cdef DTYPE_t value
 *     for x in range(xmax):
 *         for y in range(ymax):             # <<<<<<<<<<<<<<
 *             s_from = max(smid - x, -smid)
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":58
 *     for x in range(xmax):
 *         for y in range(ymax):
 *             s_from = max(smid - x, -smid)             # <<<<<<<<<<<<<<
 *             s_to = min((xmax - x) - smid, smid + 1)
 ...
 */
      ...
      /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":59
 *         for y in range(ymax):
 *             s_from = max(smid - x, -smid)
 *             s_to = min((xmax - x) - smid, smid + 1)             # <<<<<<<<<<<<<<
 *             t_from = max(tmid - y, -tmid)
 ...
 */
      ...
      /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":60
 *             s_from = max(smid - x, -smid)
 *             s_to = min((xmax - x) - smid, smid + 1)
 *             t_from = max(tmid - y, -tmid)             # <<<<<<<<<<<<<<
 *             t_to = min((ymax - y) - tmid, tmid + 1)
 ...
 */
      ...
      /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":61
 *             s_to = min((xmax - x) - smid, smid + 1)
 *             t_from = max(tmid - y, -tmid)
 *             t_to = min((ymax - y) - tmid, tmid + 1)             # <<<<<<<<<<<<<<
 *             value = 0
 ...
 */
      ...
      /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":62
 *             t_from = max(tmid - y, -tmid)
 *             t_to = min((ymax - y) - tmid, tmid + 1)
 *             value = 0             # <<<<<<<<<<<<<<
 *             for s in range(s_from, s_to):
 ...
 */
      ...
      /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":63
 *             t_to = min((ymax - y) - tmid, tmid + 1)
 *             value = 0
 *             for s in range(s_from, s_to):             # <<<<<<<<<<<<<<
 *                 for t in range(t_from, t_to):
 ...
 */
      ...
      for (__pyx_t_15 = __pyx_v_s_from; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
        ...
        /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":64
 *             value = 0
 *             for s in range(s_from, s_to):
 *                 for t in range(t_from, t_to):             # <<<<<<<<<<<<<<
 *                     v = x - smid + s
 ...
 */
        ...
        for (__pyx_t_18 = __pyx_v_t_from; __pyx_t_18 < __pyx_t_13; __pyx_t_18+=1) {
          ...
          /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":65
 *             for s in range(s_from, s_to):
 *                 for t in range(t_from, t_to):
 *                     v = x - smid + s             # <<<<<<<<<<<<<<
 *                     w = y - tmid + t
 ...
 */
          ...
          /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":66
 *                 for t in range(t_from, t_to):
 *                     v = x - smid + s
 *                     w = y - tmid + t             # <<<<<<<<<<<<<<
 *                     value += g[smid - s, tmid - t] * f[v, w]
 ...
 */
          ...
          /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":67
 *                     v = x - smid + s
 *                     w = y - tmid + t
 *                     value += g[smid - s, tmid - t] * f[v, w]             # <<<<<<<<<<<<<<
 *             h[x, y] = value
 ...
 */
          ...
          __pyx_t_21 = -1;
          if (__pyx_t_19 < 0) {
            __pyx_t_19 += __pyx_bshape_0_g;
            if (unlikely(__pyx_t_19 < 0)) __pyx_t_21 = 0;
          } else if (unlikely(__pyx_t_19 >= __pyx_bshape_0_g)) __pyx_t_21 = 0;
          if (__pyx_t_20 < 0) {
            __pyx_t_20 += __pyx_bshape_1_g;
            if (unlikely(__pyx_t_20 < 0)) __pyx_t_21 = 1;
          } else if (unlikely(__pyx_t_20 >= __pyx_bshape_1_g)) __pyx_t_21 = 1;
          ...
          __pyx_t_23 = -1;
          if (__pyx_t_21 < 0) {
            __pyx_t_21 += __pyx_bshape_0_f;
            if (unlikely(__pyx_t_21 < 0)) __pyx_t_23 = 0;
          } else if (unlikely(__pyx_t_21 >= __pyx_bshape_0_f)) __pyx_t_23 = 0;
          if (__pyx_t_22 < 0) {
            __pyx_t_22 += __pyx_bshape_1_f;
            if (unlikely(__pyx_t_22 < 0)) __pyx_t_23 = 1;
          } else if (unlikely(__pyx_t_22 >= __pyx_bshape_1_f)) __pyx_t_23 = 1;
          if (unlikely(__pyx_t_23 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_23);
            {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          }
          __pyx_v_value += ((*__Pyx_BufPtrStrided2d(__pyx_t_9convolve2_DTYPE_t *, __pyx_bstruct_g.buf, __pyx_t_19, __pyx_bstride_0_g, __pyx_t_20, __pyx_bstride_1_g)) * (*__Pyx_BufPtrStrided2d(__pyx_t_9convolve2_DTYPE_t *, __pyx_bstruct_f.buf, __pyx_t_21, __pyx_bstride_0_f, __pyx_t_22, __pyx_bstride_1_f)));
        }
      }

      /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":68
 *                     w = y - tmid + t
 *                     value += g[smid - s, tmid - t] * f[v, w]
 *             h[x, y] = value             # <<<<<<<<<<<<<<
 *     return h
 */
      ...
      } else if (unlikely(__pyx_t_14 >= __pyx_bshape_0_h)) __pyx_t_13 = 0;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_bshape_1_h;
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_13 = 1;
      } else if (unlikely(__pyx_t_15 >= __pyx_bshape_1_h)) __pyx_t_13 = 1;
      if (unlikely(__pyx_t_13 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_13);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      *__Pyx_BufPtrStrided2d(__pyx_t_9convolve2_DTYPE_t *, __pyx_bstruct_h.buf, __pyx_t_14, __pyx_bstride_0_h, __pyx_t_15, __pyx_bstride_1_h) = __pyx_v_value;
    }
  }

  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":69
 *                     value += g[smid - s, tmid - t] * f[v, w]
 *             h[x, y] = value
 *     return h             # <<<<<<<<<<<<<<
 */
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("naive_convolve"), (PyCFunction)__pyx_pf_9convolve2_naive_convolve, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_convolve2(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("convolve2"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":2
 ...
 */
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":10
 ...
 */
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/convolve/convolve2.pyx":1
 * from __future__ import division             # <<<<<<<<<<<<<<
 * import numpy as np
 * # "cimport" is used to import special compile-time information
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init convolve2");
