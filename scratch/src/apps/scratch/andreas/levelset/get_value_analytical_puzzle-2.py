...
if __name__ == '__main__':
    ...
    b='(y-0.029)**2+(x-0.0578)**2-0.011**2;(x<=0.1400)&(x>=0.0578)&(y>=0.020)'
    c='(y-0.029)**2+(x+0.0578)**2-0.011**2;(x>=-0.1400)&(x<=-0.0578)&(y>=0.020)'
    d='-(y-0.011)**2-(x-(0.0578+0.01264911))**2+(0.011)**2;(x>=0)&(x<=(0.0578+0.01264911))&(y<=0.020)'
    e='-(y-0.011)**2-(x+0.0578+0.01264911)**2+(0.011)**2;(x<=0)&(x>=-(0.0578+0.01264911))&(y<=0.020)'
