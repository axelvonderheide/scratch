...
#                              'ps_verf_varA_w_asym_s_asym.csv',
    ...
    def read_data( self ):
        ...
        print '*** read shrinkage data from file: %s ***' % ( file_name )
...
#        rc( 'text.latex', )
        ...
        fig = pyplot.figure( facecolor = "white", figsize = [10, 6] )
        ...
        ax1.plot( 9009, -0.00391536706121 , marker = 'o', color = 'b', markerfacecolor = 'b', markersize = 8 )#

#        x = input_array[:, 0]
#        y = input_array[:, 2] * 0.022159457817 / .00391536706121
#        ax1.plot( x, y, label = str( param ) , linewidth = 1.5 )

        ax1.set_xlabel( 'Freiheitsgrade', fontsize = 20 )
        ax1.set_ylabel( '$u_z$[m]', fontsize = 20 )
        ax1.set_xlim( 0, 2000 )
        ax1.set_xlim( 0, 15000 )
        ax1.set_ylim( -0.004, -.0035 )
