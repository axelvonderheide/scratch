...
#   from ibvpy.fets.fets2D5.fets2D58h import FETS2D58H
    ...
    ts = TS(
            sdomain = domain,
            bcond_list = [BCSlice( var = 'u', value = 0., dims = [0,1,2], slice = domain[0,0,0,0,0,0] ),
                          BCSlice( var = 'u', value = 0., dims = [0], slice = domain[0,:,:,0,:,:] ),
                          BCSlice( var = 'u', value = 0., dims = [1], slice = domain[0,0,-1,0,0,-1] ),
                          BCSlice( var = 'f', value = 1.0, dims = [0], slice = loading_slice )],
             rtrace_list = [ 
